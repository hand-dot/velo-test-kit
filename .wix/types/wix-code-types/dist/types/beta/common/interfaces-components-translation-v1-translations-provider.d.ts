declare module "interfaces-components-translation-v1-translations-provider" {
  ...
  interface ComponentData extends ComponentDataDataOneOf {
       ...
       * Learn More: https://dev.wix.com/api/rest/wix-ecommerce/shipping-rates-integration-spi
       */
       ...
       * Learn More: https://dev.wix.com/api/rest/wix-ecommerce/additional-fees-integration-spi
       */
  ...
  interface ExternalDatabaseSpiConfig {
      /** URI where the SPI Implementer is deployed */
      uriConfig?: SpiBaseUri;
      /** The namespace of the external database. It will be used to access collections within the database, for example `namespace/collectionId`. */
      namespace?: string;
  }
  ...
  interface PricingPlansFormConfiguration {
      ...
      /** Ids of embeddable components to be rendered in the form */
  ...
  interface FreeOptionConfiguration {
      ...
      /** Number, specifying option position in pricing options list (starts at 1) */
      position?: number;
  }
  ...
  interface Illustration extends IllustrationIllustrationOneOf {
      /** Custom component id to be rendered as illustration */
      componentId?: string;
  ...
  interface PlanFormCustomSection {
      /** Id of embeddable component to be rendered in the form */
      componentId?: string;
  }
  interface PlanFormSection extends PlanFormSectionSectionOneOf {
      ...
      /** Number, specifying section's position in benefit list (starts at 1) */
      position?: number;
  }
  /** @oneof */
  ...
  interface Schema {
      ...
      key?: SchemaKey;
      /** A list of unique fields on the entity in the specfic language */
      ...
      /** @readonly */
      _updatedDate?: Date;
      /** indicate if the content should be duplicate when the site is duplicate */
  ...
  interface FixedHeightOption {
      height?: number;
  }
  interface WidgetSizeHeight extends WidgetSizeHeightHeightOneOf {
      /** Height in pixels */
      fixedOptions?: FixedHeightOption;
  ...
  /** @oneof */
  interface WidgetSizeHeightHeightOneOf {
      /** Height in pixels */
      fixedOptions?: FixedHeightOption;
  }
  interface Width {
