declare module "wix-portfolio-backend" {
  ...
  type portfolioProjectsV1Project_universal_d_DomainEvent = DomainEvent;
  type portfolioProjectsV1Project_universal_d_DomainEventBodyOneOf = DomainEventBodyOneOf;
  type portfolioProjectsV1Project_universal_d_EntityCreatedEvent = EntityCreatedEvent;
  type portfolioProjectsV1Project_universal_d_EntityUpdatedEvent = EntityUpdatedEvent;
  type portfolioProjectsV1Project_universal_d_EntityDeletedEvent = EntityDeletedEvent;
  type portfolioProjectsV1Project_universal_d_ActionEvent = ActionEvent;
  ...
  namespace portfolioProjectsV1Project_universal_d {
    export {
      ...
      portfolioProjectsV1Project_universal_d_DomainEvent as DomainEvent,
      portfolioProjectsV1Project_universal_d_DomainEventBodyOneOf as DomainEventBodyOneOf,
      portfolioProjectsV1Project_universal_d_EntityCreatedEvent as EntityCreatedEvent,
      portfolioProjectsV1Project_universal_d_EntityUpdatedEvent as EntityUpdatedEvent,
      portfolioProjectsV1Project_universal_d_EntityDeletedEvent as EntityDeletedEvent,
      portfolioProjectsV1Project_universal_d_ActionEvent as ActionEvent,
  ...
  const portfolioProjectsV1ProjectInCollection_universal_d___debug: typeof __debug;
  ...
  namespace portfolioProjectsV1ProjectInCollection_universal_d {
    export {
      portfolioProjectsV1ProjectInCollection_universal_d___debug as __debug,
