declare module "wix-stores-backend.v3" {
   ...
   * @adminMethod
   */
  function catalogCreateProduct(product: ProductComposite, options?: CatalogCreateProductOptions): Promise<CreateProductResponse>;
   ...
   * @adminMethod
   */
  function catalogUpdateProduct(_id: string | null, product: CatalogUpdateProduct, options?: CatalogUpdateProductOptions): Promise<UpdateProductResponse>;
