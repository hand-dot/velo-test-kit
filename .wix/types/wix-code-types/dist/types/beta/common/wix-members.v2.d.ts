declare module "wix-members.v2" {
  ...
  namespace membersV1Member_universal_d {
    export {
      ...
      membersV1Member_universal_d_BulkDeleteMembersOptions as BulkDeleteMembersOptions,
  ...
  namespace membersV1Role_universal_d {
    export {
      membersV1Role_universal_d___debug as __debug,
      membersV1Role_universal_d_Role as Role,
      membersV1Role_universal_d_SyncRolesRequest as SyncRolesRequest,
      membersV1Role_universal_d_SyncRolesResponse as SyncRolesResponse,
      ...
      membersV1Role_universal_d_syncRoles as syncRoles,
      membersV1Role_universal_d_SyncRolesOptions as SyncRolesOptions,
