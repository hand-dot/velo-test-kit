declare module "wix-stores.v2" {
  ...
  namespace storesV1SubscriptionOption_universal_d {
    export {
      ...
      storesV1SubscriptionOption_universal_d_SubscriptionOptionCreated as SubscriptionOptionCreated,
      storesV1SubscriptionOption_universal_d_SubscriptionOptionChanged as SubscriptionOptionChanged,
      storesV1SubscriptionOption_universal_d_SubscriptionOptionDeleted as SubscriptionOptionDeleted,
      storesV1SubscriptionOption_universal_d_SubscriptionOptionsAssignmentChangedForProduct as SubscriptionOptionsAssignmentChangedForProduct,
      storesV1SubscriptionOption_universal_d_SubscriptionOptionWithVisibility as SubscriptionOptionWithVisibility,
      storesV1SubscriptionOption_universal_d_OneTimePurchasesChanged as OneTimePurchasesChanged,
   ...
   * and will be removed on June 30, 2024.
   *
   * </blockquote>
   *
   * Creates a new order.
  ...
  namespace storesV2Orders_universal_d {
    export {
      storesV2Orders_universal_d___debug as __debug,
