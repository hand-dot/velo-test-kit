declare module "wix-forms.v2" {
   ...
   * @adminMethod
   */
  function querySubmissionsByNamespace(query: CursorQuery, options?: QuerySubmissionsByNamespaceOptions): Promise<QuerySubmissionsByNamespaceResponse>;
   ...
   * @adminMethod
   */
  function querySubmissionsByNamespaceForExport(): SubmissionsQueryBuilder;
  ...
  interface ValidateSubmissionRequest extends ValidateSubmissionRequestActionsOneOf {
      ...
      /**
       * Data for creating a submission. <br>
       * <b>Note:</b> The API automatically takes the data from the `submission` object.
       */
  ...
  const interfacesFormsV4SubmissionExtension_universal_d___debug: typeof __debug;
  ...
  type interfacesFormsV4SubmissionExtension_universal_d_CreateOptions = CreateOptions;
  ...
  namespace interfacesFormsV4SubmissionExtension_universal_d {
    export {
      interfacesFormsV4SubmissionExtension_universal_d___debug as __debug,
      ...
      interfacesFormsV4SubmissionExtension_universal_d_CreateOptions as CreateOptions,
