declare module "interfaces-items-selection-v1-items-selection-provider" {
  ...
  interface QueryItemsRequest {
      /** Query options. */
      query?: Query;
      /** A tag representing the Wix service requesting the list of items. Supported values: "UNKNOWN_TAG", "EMBEDDABLE", "ECOM_EDIT_ORDER" . */
      tag?: Tag;
  }
  ...
  export { AdditionalData, AdditionalDataDataOneOf, AdditionalStepInfo, BusinessError, Code, ContentData, Context, CreateNewItemInfo, CursorPaging, Cursors, EcomCatalogData, FailureData, FilterInfo, FilterInfoOptionsOneOf, FilterOptionsType, FilterSelectionType, IdentificationData, IdentificationDataIdOneOf, IdentityType, Image, Item, ItemsSelectionProviderConfig, LearnMore, Paging, PagingMetadataV2, Query, QueryError, QueryItemsOptions, QueryItemsRequest, QueryItemsResponse, QueryPagingMethodOneOf, SearchField, SearchParams, SortOrder, Sorting, StaticFilterOption, StaticFilterOptions, Tag, spiErrorHelpers_d as errorHelpers };
}
