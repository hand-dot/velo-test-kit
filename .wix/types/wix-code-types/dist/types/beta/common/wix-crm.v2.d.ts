declare module "wix-crm.v2" {
   ...
   *
   * >**Note:** Only visitors with **Manage Contacts** permissions can run this function.
  ...
  const crmTasksV2Task_universal_d___debug: typeof __debug;
  ...
  namespace crmTasksV2Task_universal_d {
    export {
      crmTasksV2Task_universal_d___debug as __debug,
