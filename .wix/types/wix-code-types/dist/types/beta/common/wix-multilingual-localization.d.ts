declare module "wix-multilingual-localization" {
  ...
  const multilingualLocalizationV1LocalizedContent_universal_d___debug: typeof __debug;
  ...
  namespace multilingualLocalizationV1LocalizedContent_universal_d {
    export {
      multilingualLocalizationV1LocalizedContent_universal_d___debug as __debug,
