declare module "wix-multilingual.v2" {
   ...
   * @documentationMaturity preview
   */
  function queryContents(): ContentsQueryBuilder;
  ...
  const multilingualTranslationV1Schema_universal_d___debug: typeof __debug;
  ...
  namespace multilingualTranslationV1Schema_universal_d {
    export {
      multilingualTranslationV1Schema_universal_d___debug as __debug,
