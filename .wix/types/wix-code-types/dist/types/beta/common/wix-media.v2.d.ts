declare module "wix-media.v2" {
  ...
  interface ItemsQueryBuilder {
       ...
       * @documentationMaturity preview
       */
      eq: (propertyName: 'title' | '_createdDate' | '_updatedDate', value: any) => ItemsQueryBuilder;
       ...
       * @documentationMaturity preview
       */
      ascending: (...propertyNames: Array<'title' | '_createdDate' | '_updatedDate'>) => ItemsQueryBuilder;
      /** @param propertyNames - Properties used in the sort. To sort by multiple properties, pass properties as additional arguments.
       * @documentationMaturity preview
       */
      descending: (...propertyNames: Array<'title' | '_createdDate' | '_updatedDate'>) => ItemsQueryBuilder;
  ...
  const mediaSiteMediaV1StorageInfo_universal_d___debug: typeof __debug;
  ...
  namespace mediaSiteMediaV1StorageInfo_universal_d {
    export {
      mediaSiteMediaV1StorageInfo_universal_d___debug as __debug,
