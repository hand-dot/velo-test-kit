declare module "wix-loyalty.v2" {
  ...
  interface PointsExpirationInactivityTimeChanged {
      /** Loyalty program. */
      loyaltyProgram?: LoyaltyProgram;
  }
  ...
  type loyaltyV1Program_universal_d_PointsExpirationInactivityTimeChanged = PointsExpirationInactivityTimeChanged;
  ...
  namespace loyaltyV1Program_universal_d {
    export {
      ...
      loyaltyV1Program_universal_d_PointsExpirationInactivityTimeChanged as PointsExpirationInactivityTimeChanged,
  ...
  namespace loyaltyV1Tier_universal_d {
    export {
      loyaltyV1Tier_universal_d___debug as __debug,
