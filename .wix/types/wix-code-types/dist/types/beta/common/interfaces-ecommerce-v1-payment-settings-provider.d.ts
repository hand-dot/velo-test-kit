declare module "interfaces-ecommerce-v1-payment-settings-provider" {
  ...
  interface BalanceSummary {
      /**
       * collectible amount to pay. Part of order’s price_summary excluding all approved payments amount
       * @readonly
       */
      balance?: Balance;
      /**
       * Sum of all historically approved (succeeded) payments
       * including those which had been subsequently refunded or partially refunded
       * @internal
       * @readonly
       */
      paid?: Price;
      /**
       * Sum of all refunded payments ( with status success )
       * @internal
       * @readonly
       */
      refunded?: Price;
