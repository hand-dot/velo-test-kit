declare module "wix-forum.v2" {
     ...
     * @adminMethod
     */
    function createCategory(options?: CreateCategoryOptions): Promise<CategoryResponse>;
     ...
     * @adminMethod
     */
    function updateCategory(categoryId: string, options?: UpdateCategoryOptions): Promise<CategoryResponse>;
    ...
    interface Post {
        ...
        /**
         * The post content as a stringified DraftJs document.
         * @internal
         * @readonly
         */
        content?: string | null;
     ...
     * @adminMethod
     */
    function createPost(options?: CreatePostOptions): Promise<CreatePostResponse>;
     ...
     * @adminMethod
     */
    function updatePost(postId: string, options?: UpdatePostOptions): Promise<UpdatePostResponse>;
